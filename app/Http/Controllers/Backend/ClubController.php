...
class ClubController extends Controller
{
    ...
    }public function club()
    {
        ...
        return view('backend.club.club',compact('club'));
    }public function anggota_club($id)
    {
        ...
        return view('backend.club.anggota_club',compact('club','id'));
    }
	public function foto_kegiatan_club($id,$id_kegiatan)
    {
        ...
        return view('backend.club.foto_kegiatan_club',compact('club','id','id_kegiatan','help'));
    }
	...
	public function kegiatan_club($id)
    {
        ...
        return view('backend.club.kegiatan_club',compact('club','id','help'));
    }
    ...
    public function tambah_kegiatan_club($id)
    {
        ...
        return view('backend.club.tambah_kegiatan_club',compact('karyawan','id'));
    }public function tambah_foto_kegiatan_club ($id,$id_kegiatan)
    {
        return view('backend.club.tambah_foto_kegiatan_club ',compact('id','id_kegiatan'));
        ...
        try{
            ...
            DB::commit();
            return redirect()->route('be.foto_kegiatan_club',[$id,$id_kegiatan])->with('success','Club Berhasil di input!');
        }
        catch(\Exeception $e){
            DB::rollback();
        ...
        try{
            ...
            DB::commit();
            return redirect()->route('be.kegiatan_club',$id)->with('success','Club Berhasil di input!');
        }
        catch(\Exeception $e){
            DB::rollback();
            return redirect()->back()->with('error',$e);
...
public function tambah_anggota_club($id)
    {
        ...
        return view('backend.club.tambah_anggota_club',compact('karyawan','id'));
    }
     public function simpan_anggota_club(Request $request,$id){
        ...
        try{
            ...
            DB::commit();
            return redirect()->route('be.anggota_club',$id)->with('success','Club Berhasil di input!');
        }
        catch(\Exeception $e){
            DB::rollback();
            return redirect()->back()->with('error',$e);
    ...
    }public function hapus_anggota_club($id,$id_anggota)
    {
        ...
        try{
            DB::connection()->table("club_karyawan")
                ...
                ->delete();
            DB::commit();
            return redirect()->route('be.anggota_club',$id)->with('success','Club Berhasil di Hapus!');
        }
        catch(\Exeception $e){
            DB::rollback();
            return redirect()->back()->with('error',$e);
    ...
    }public function hapus_foto_club($id,$id_kegiatan,$id_foto)
    {
        ...
        try{
            DB::connection()->table("club_foto")
                ...
                ->update(["active"=>0]);
            DB::commit();
            return redirect()->route('be.foto_kegiatan_club',[$id,$id_kegiatan])->with('success','Club Berhasil di Hapus!');
        }
        catch(\Exeception $e){
            DB::rollback();
            return redirect()->back()->with('error',$e);
    ...
    public function tambah_club()
    {
        ...
        return view('backend.club.tambah_club',compact('karyawan'));
    }
    ...
    public function simpan_club(Request $request){
        ...
        try{
            ...
            DB::commit();
            return redirect()->route('be.club')->with('success','Club Berhasil di input!');
        }
        catch(\Exeception $e){
            DB::rollback();
            return redirect()->back()->with('error',$e);
...
where users.id=$iduser";
        ...
        return view('backend.club.edit_club', compact('club','id'));
    }
    ...
    public function update_club(Request $request, $id){
        ...
        try{
            ...
            DB::connection()->table("club")
                ...
                ->update($data);
            DB::commit();
            return redirect()->route('be.club')->with('success','Club Berhasil di Ubah!');
        }
        catch(\Exeception $e){
            DB::rollback();
            return redirect()->back()->with('error',$e);
    ...
    public function hapus_club($id)
    {
        ...
        try{
            DB::connection()->table("club")
                ...
                ->delete();
            DB::commit();
            return redirect()->route('be.club')->with('success','Club Berhasil di Hapus!');
        }
        catch(\Exeception $e){
            DB::rollback();
            return redirect()->back()->with('error',$e);
