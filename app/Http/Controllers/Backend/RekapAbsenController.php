...
class RekapAbsenController extends Controller{
	...
	public function view(Request $request){
		...
		if($request->get('Cari')!='Generate' and !empty($request->get('Cari'))){
    	 ...
    	 //echo '<pre>';	print_r($rekap['lembur']['approve'][247]);
        ...
        $return_lembur = $help->total_rekap_absen_optimasi($rekap, 247);
        ...
        $tgl_awal_lembur_ajuan = $tgl_awal;
          foreach ($lembur as $lembur) {
           $id_karyawan = $lembur->p_karyawan_id;
            ...
            if (!isset($rekap['total_lembur'][$id_karyawan])) {
                $rekap['total_lembur'][$id_karyawan]['total_pengajuan'] = 0;
                $rekap['total_lembur'][$id_karyawan]['total_pending'] = 0;
                $rekap['total_lembur'][$id_karyawan]['total_approve'] = 0;
                $rekap['total_lembur'][$id_karyawan]['total_tolak'] = 0;
                $rekap['total_lembur'][$lembur->p_karyawan_id]['total_lembur_proposional'] = 0;
                $rekap['total_lembur'][$id_karyawan]['tgl_pending'] = '';
            }
            $rekap['total_lembur'][$id_karyawan]['total_pengajuan'] += (int)$lembur->lama;
            if (($lembur->status_appr_1 == 1 and $lembur->appr_2 == null)
                ...
                $rekap['total_lembur'][$id_karyawan]['total_approve'] += (int)$lembur->lama;

                $array_tgl[] =  $lembur->tgl_awal;;
                $tgl_appr = $lembur->tgl_awal;
                if($lembur->tipe_lembur=='Lembur Proposional'){
                    $rekap['Proposional']['ajuan'][$lembur->p_karyawan_id][$lembur->tgl_awal]['tipe_lembur'] = $lembur->tipe_lembur;
                    $rekap['Proposional']['ajuan'][$lembur->p_karyawan_id][$lembur->tgl_awal]['tgl_awal'] = $lembur->tgl_awal;
                    $rekap['Proposional']['ajuan'][$lembur->p_karyawan_id][$lembur->tgl_awal]['tgl_akhir'] = $lembur->tgl_akhir;
                    
                    $rekap['Proposional']['ajuan'][$lembur->p_karyawan_id][$lembur->tgl_awal]['lama'] = $lembur->lama;
                    $rekap['Proposional']['ajuan'][$lembur->p_karyawan_id][$lembur->tgl_awal]['keterangan'] = $lembur->keterangan;
                    $rekap['Proposional']['ajuan'][$lembur->p_karyawan_id][$lembur->tgl_awal]['jam_awal'] = $lembur->jam_awal;
                    $rekap['Proposional']['ajuan'][$lembur->p_karyawan_id][$lembur->tgl_awal]['jam_akhir'] = $lembur->jam_akhir;
                    
                    $rekap['Proposional']['approve'][$lembur->p_karyawan_id][$tgl_appr]['tipe_lembur'] = $lembur->tipe_lembur;
                    $rekap['Proposional']['approve'][$lembur->p_karyawan_id][$tgl_appr]['tgl_awal'] = $lembur->tgl_awal;
                    $rekap['Proposional']['approve'][$lembur->p_karyawan_id][$tgl_appr]['tgl_akhir'] = $lembur->tgl_akhir;
                    
                    $rekap['Proposional']['approve'][$lembur->p_karyawan_id][$tgl_appr]['lama'] = $lembur->lama;
                    $rekap['Proposional']['approve'][$lembur->p_karyawan_id][$tgl_appr]['keterangan'] = $lembur->keterangan;
                    $rekap['Proposional']['approve'][$lembur->p_karyawan_id][$tgl_appr]['jam_awal'] = $lembur->jam_awal;
                    $rekap['Proposional']['approve'][$lembur->p_karyawan_id][$tgl_appr]['jam_akhir'] = $lembur->jam_akhir;
            ...
            DB::connection()->table("t_permit")->where("t_form_exit_id",$lembur->t_form_exit_id)->update(["master"=>1]);     
                ...
                $rekap['total_lembur'][$id_karyawan]['total_tolak'] += (int)$lembur->lama;
            } else {
                $rekap['total_lembur'][$id_karyawan]['total_pending'] += (int)$lembur->lama;
                $rekap['total_lembur'][$id_karyawan]['tgl_pending'] .= $lembur->tgl_awal . ' | ';
            }
        }
        //print_r($rekap['Proposional']['approve']);
	  if(isset($rekap)){
	    $array['periode_absen_id'] = $periode_absen_id;
	    $array['array_rekap'] = json_encode($rekap);
	    $array['create_date'] = date('Y-m-d H:i:s');
