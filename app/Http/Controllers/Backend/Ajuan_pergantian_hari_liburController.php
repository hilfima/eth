...
class Ajuan_Pergantian_Hari_LiburController extends Controller
{
...
where users.id=$iduser";
        ...
        $where ="";
        if($request->tgl_awal)
	        $where .=" and a.tgl_pengajuan >= '".$request->tgl_awal."'";
        if($request->tgl_akhir)
	        $where .=" and a.tgl_pengajuan <= '".$request->tgl_akhir."'";
          $sqlharilibur="SELECT a.*,b.*,c.nama as appr,b.nama as nama_lengkap
                       FROM t_pergantian_hari_libur a
        ...
        return view('backend.pergantian_hari_libur.pergantian_hari_libur',compact('harilibur','request'));
    }
