...
class Pengajuan_resignController extends Controller
{
    ...
    }public function pengajuan_resign(Request $request)
	{
		...
		$type ="karyawan";
		$type='karyawan';
		return view('frontend.pengajuan_resign.pengajuan_resign',compact('pengajuan_resign','type','idkaryawan'));
	}
	...
	public function edit_pengajuan_resign($id,$page)
	{
		...
		return view('frontend.pengajuan_resign.tambah_pengajuan_resign',compact('id','data','type','page'));
	}
...
$iduser=Auth::user()->id;
		...
		$page = 'karyawan';
		return view('frontend.pengajuan_resign.tambah_pengajuan_resign',compact('id','data','type','karyawan','jenis_sanksi','appr1','appr2','page'));
	}public function simpan_pengajuan_resign(Request $request)
	{
		...
		return redirect()->route('fe.pengajuan_resign')->with('success',' Pengajuan Berhasil di input!');
	}public function update_pengajuan_resign (Request $request, $id)
	{
		...
		return redirect()->route('fe.pengajuan_resign')->with('success',' kotak_laporan Berhasil di input!');
