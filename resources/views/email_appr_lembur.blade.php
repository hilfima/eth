                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td class="subhead" style="padding: 5px 0 0 0;">
                                    Approval Email Pengajuan Lembur
                                </td>
                            </tr>
                            <tr>
                    ...
                    <td class="innerpadding borderbottom">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td align="left" valign="top" style="width: 100px">Jenis Lembur</td>
                                    <td align="center" valign="top" style="width: 5px">:</td>
                                ...
                                <tr>
                                    <td align="left" valign="top" style="width: 100px">Jam Awal</td>
                                    <td align="center" valign="top" style="width: 5px">:</td>
                                    <td align="left">{!! $data[0]->jam_awal !!}</td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top" style="width: 100px">Jam Akhir</td>
                                    <td align="center" valign="top" style="width: 5px">:</td>
                                    <td align="left">{!! $data[0]->jam_akhir !!}</td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top" style="width: 100px">Lama (Jam)</td>
                                    <td align="center" valign="top" style="width: 5px">:</td>
                                    <td align="left">{!! $data[0]->lama !!}</td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top" style="width: 100px">Tipe Lembur</td>
                                    <td align="center" valign="top" style="width: 5px">:</td>
                                    <td align="left">{!! $data[0]->tipe_lembur !!}</td>
                                </tr>
                                <tr>
                                        ...
                                        <tr>
                                                ...
                                                <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="button" height="45">
                                                            <a href="http://203.210.84.185:84/approve_lembur/{!! $data[0]->kode !!}" target="_blank">Setuju</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td style="padding: 20px 0 0 0;">
                                                <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="button" height="45">
                                                            <a href="http://203.210.84.185:84/reject_lembur/{!! $data[0]->kode !!}" target="_blank">Tolak</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
