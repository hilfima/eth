                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td class="subhead" style="padding: 5px 0 0 0;">
                                    Approval Email Pengajuan Perjalanan Dinas
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tr>
                                                ...
                                                <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="button" height="45">
                                                            <a href="{!! route('approve_perdin',$data[0]->kode) !!}" target="_blank">Setuju</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td style="padding: 20px 0 0 0;">
                                                <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="button" height="45">
                                                            <a href="{!! route('reject_perdin',$data[0]->kode) !!}" target="_blank">Tolak</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
