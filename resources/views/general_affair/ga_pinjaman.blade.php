...
<div class="container">
    <hr>
    <p><h2 align="center"><b>FORM PENGAJUAN PINJAMAN</b></h2></p>
    <hr>
    <br/>
    ...
    <div class="table-responsive">
        ...
        <form method="post" id="dynamic_forms" action="{!! route('simpan_ga_pinjaman') !!}">
        @csrf
            <!--<span id="result"></span>-->
            <div class="row">
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="no_pengajuan" name="no_pengajuan" value="{!! $NoDokumen !!}" readonly/>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
            ...
            <table class="table table-bordered table-striped" id="user_table">
                ...
                <tr>
                    ...
                    <td>
                        @csrf
                        <a href="{!! route('ga') !!}" class="btn btn-primary">Kembali</a>
...
<script>
    $(document).ready(function(){
        ...
        function dynamic_field(number)
        {
            ...
            html += '<td><input type="text" name="peruntukan[]" class="form-control" /></td>';
            html += '<td><input type="text" name="lama_pinjam[]" class="form-control" /></td>';
            html += '<td><input type="text" name="tgl_digunakan[]" class="form-control" placeholder="yyyy-mm-dd" /></td>';
            html += '<td><input type="text" name="tgl_dikembalikan[]" class="form-control" placeholder="yyyy-mm-dd" /></td>';
            if(number > 1)
            {
