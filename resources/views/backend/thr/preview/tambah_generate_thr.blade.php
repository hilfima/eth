...
<div class="content-wrapper">
	...
	<div class="card">
		<div class="card-body">
			...
			<form id="cari_absen" class="form-horizontal" method="post" action="{!! route('be.post_generate_thr') !!}">
				{{ csrf_field() }}
				<div class="row">
				<div class="col-sm-12">
                            <!-- text input -->
                            ...
                            <div class="form-group">
                                <label>Tanggal </label>
                              	...
                              	<span >Tanggal ini digunakan untuk menghitung persentasi perhitungan gaji karyawan yang kurang dari 1 Tahun</span>
