    ...
    @include('flash-message')
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{!! route('be.tambah_jabatan') !!}" class="btn btn-primary" title='Tambah' data-toggle='tooltip'><span class='fa fa-plus'></span>  Jabatan </a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                    ...
                    @if(!empty($jabatan))
                        @foreach($jabatan as $jabatan)
                            ...
                            <tr>
                                ...
                                <td>{!! $jabatan->nmdivisi !!}</td>
                                <td>{!! $jabatan->nama_divisi !!}</td>
                                <td>{!! $jabatan->nama_directorat !!}</td>
                                <td>{!! $jabatan->nmentitas !!}</td>
