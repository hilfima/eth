				   ...
				   ?>
				    <tr>
				      ...
				      <td><?=$list_karyawan->type_gaji;?></td>
				       <?php if($data['page']=='non_ajuan' or $data['page']=='ajuan'){?><td><a href="javascript:void(0)" onclick="keterangan('<?=$list_karyawan->prl_generate_karyawan_id;?>','<?=$list_karyawan->p_karyawan_id;?>','<?=$list_karyawan->m_lokasi_id?>','<?=$list_karyawan->nmentitas?>','<?=$list_karyawan->pajak_onoff?>','<?=$list_karyawan->m_jabatan_id?>','<?=$list_karyawan->nmjabatan?>','<?=$list_karyawan->m_bank_id?>','<?=$list_karyawan->nama_bank?>','<?=$list_karyawan->norek?>','<?=$list_karyawan->type_gaji?>')"><span class="fa fa-edit"></span></a></td><?php }?>
				    </tr>
				  <?php }?>
				   	 <td><b>JUMLAH</b></td>
				      <td></td>
