...
@section('content')
    ...
    @include('flash-message')
        ...
        <div class="card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{!! route('be.simpan_hari_libur') !!}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="tanggal" data-target-input="nearest">
                                    <input type="date" class="form-control " id="tanggal" name="tanggal_awal" data-target="#tanggal" />
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="tanggal" data-target-input="nearest">
                                    <input type="date" class="form-control " id="tanggal" name="tanggal_akhir" data-target="#tanggal" />
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control " name="berulang" style="width: 100%;" value="0" type="hidden">
                      
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Cuti Bersama *</label>
                                <select class="form-control select2" name="cuti_bersama" style="width: 100%;" onchange="cutber(this)" required>
                        ...
                        <div class="col-sm-12">
                        <div id="cutber" class="row" style="display: none">
                        	
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Tipe Cuti Bersama *</label>
                                <select class="form-control select2" name="tipe_cuti_bersama" style="width: 100%;" >
                                    <option value="">Pilih</option>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="pengkhususan[]" style="width: 100%;" multiple>
                                    <option value="">Pilih</option>
                                ...
                                jika semua entitas, kosongkan saja..
                            </div>
                        </div><!--
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Pengecualian</label>
                                <select class="form-control select2" name="pengecualian[]" style="width: 100%;" multiple="">
                                    <option value="">Pilih</option>
                                    <?php foreach($entitas as $lokasi){?>
                                    	<option value="<?=$lokasi->m_lokasi_id;?>"><?=$lokasi->nama;?></option>
    ...
    <script>
    	function cutber(e){
    		...
    		if($(e).val()==0) $('#cutber').hide(); else if($(e).val()==1) $('#cutber').show(); 
    	}
    </script>
    <!-- /.content-wrapper -->
@endsection
