...
<h4 class="card-title float-left mb-0 mt-2">Tambah Parameter</h4>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{!! route('be.simpan_kpi_pencapaian',[$id,$id2,$type]) !!}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                            ...
                            <div class="form-group" > 
                            	...
                            	<textarea class="form-control" placeholder="Area kerja" id="alasan" name="sasaran_kerja" readonly="" >{{$kpi_detail[0]->nama_area_kerja}}</textarea>
                            </div><div class="form-group" > 
                            	 <label>Sasaran Kerja</label>                               
                            	<textarea class="form-control" placeholder="Sasaran Kerja" id="alasan" name="sasaran_kerja" readonly="" >{{$kpi_detail[0]->sasaran_kerja}}</textarea>
                            </div>
                            <div class="form-group" > 
                            	 <label>Definisi</label>                               
                            	<textarea class="form-control" placeholder="Definisi" id="alasan" name="definisi"readonly="" >{{$kpi_detail[0]->definisi}}</textarea>
                            </div>
                            <div class="form-group " > 
							     ...
							     ?>
                            	<input class="form-control" placeholder="Pencapaian" id="alasan" name="pencapaian" type="number" required="" value="{{$kpi_detail[0]->$row}}">
