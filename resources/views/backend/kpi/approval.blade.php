	...
	font-weight: 900;
                    ...
                    <tr>
                        ...
                        <td>{!! $kpi->goals_utama !!}</td>
                                ...
                                <td style="text-align: center">
                                    <a href="{!! route('be.kpi_detail',$kpi->t_kpi_id) !!}" title='Lihat' data-toggle='tooltip' class="btn btn-primary"><span class='fa fa-search'></span> Lihat</a><Br>
                                ...
                                <td style="text-align: center;">
                                   <div class="d-flex">
									...
									@if($kpi->status_appr_1==3 and $kpi->atasan_1==$id)
                                        ...
                                        <a href="{!! route('be.acc_kpi_1',$kpi->t_kpi_id) !!}" class="btn btn-success btn-sm mr-2"  title='Approve - 1 ' data-toggle='tooltip'> 
                                    	Approve  1
                                    </a><a href="{!! route('be.dec_kpi_1',$kpi->t_kpi_id) !!}" class="btn btn-danger btn-sm" title='Tolak - 1' data-toggle='tooltip'> 
                                    	Tolak    
                                    </a> 
                                    @endif
                                    @if($kpi->status_appr_2==3 and $kpi->atasan_2==$id  and (($kpi->status_appr_1==1 and $kpi->atasan_1!=null) or $kpi->atasan_1==null))
                                   
                                       <a href="{!! route('be.acc_kpi_2',$kpi->t_kpi_id) !!}" class="btn btn-success btn-sm"  title='Approve - 2' data-toggle='tooltip'> 
                                    	Approve     
                                    </a><a href="{!! route('be.dec_kpi_2',$kpi->t_kpi_id) !!}" class="btn btn-danger btn-sm" title='Tolak - 2' data-toggle='tooltip'> 
                                    	Tolak    
                                    </a>
                                    @elseif(($kpi->status_appr_1==3 and $kpi->atasan_1!=null and $kpi->atasan_2==$id ) )
       ...
       <!-- <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <a href="{!!route('be.listed')!!}" class="btn btn-primary"><span class="fa fa-sync"></span> Reset</a>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    @if($data2->status_appr_2==3)
                                        <a href="{!! route('be.lihat_ajuan_2',$data2->t_kpi_id) !!}" title='Lihat' data-toggle='tooltip'><span class='fa fa-search'></span></a>
                                        <a href="{!! route('be.edit_ajuan_2',$data2->t_kpi_id) !!}" title='Ubah' data-toggle='tooltip'><span class='fa fa-edit'></span></a>
                                    @else
                                        <a href="{!! route('be.lihat_ajuan_2',$data2->t_kpi_id) !!}" title='Lihat' data-toggle='tooltip'><span class='fa fa-search'></span></a>
                                    @endif
                                </td>
