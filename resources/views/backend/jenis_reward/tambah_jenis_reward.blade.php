    ...
    <!-- Content Header (Page header) -->
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title mb-0	"><?=ucwords('Jenis Reward');?></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <!-- form start -->
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
								...
								<input type="text" class="form-control " id="nama" name="nama" placeholder="Nama Jenis Reward" value="<?=$data['nama']?>">
                        ...
                        <a href="{!! route('be.jenis_reward') !!}" class="btn btn-default pull-left"><span class="fa fa-times"></span> Kembali</a>
