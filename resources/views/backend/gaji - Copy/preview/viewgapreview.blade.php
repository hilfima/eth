            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><?php 
                    	...
                    	else if(@$data['page']=='direksi') echo 'Approval Direksi';
                    ?></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <tr>
                    ...
                    <td>
                    	@if(@$data['page']=='non_ajuan')
                    		 <a href="{!! route('be.previewgaji', ['non_ajuan', 'prl_generate=' . $generate->prl_generate_id . '&menu=Gaji&Cari=Cari&preview=preview&entitas='.$generate->m_lokasi_id]) !!}" target="_blank" title='Preview' data-toggle='tooltip'><span class='fa fa-eye'></span> </a>
                    	@elseif(@$data['page']=='direksi')
                    	<a href="{!! route('be.previewgaji', ['direksi', 'prl_generate=' . $generate->prl_generate_id . '&menu=Gaji&Cari=Cari&view=view&entitas='.$generate->m_lokasi_id]) !!}" target="_blank" title='Preview' data-toggle='tooltip'><span class='fa fa-eye'></span> </a>
                    		@if($generate->appr_off_hr_status==1 and $generate->appr_on_hr_status==1 )
                    			...
                    			<a href="{!! route('be.previewgaji', ['direksi', 'prl_generate=' . $generate->prl_generate_id . '&menu=Gaji&Cari=Cari&view=appr&preview=Gaji&entitas='.$generate->m_lokasi_id]) !!}" target="_blank" title='Approval' data-toggle='tooltip'><span class='fa fa-edit'></span> </a>
                    			@elseif($generate->appr_off_direktur_status==1 and $generate->appr_on_direktur_status!=1)
                    			<a href="{!! route('be.previewgaji', ['direksi', 'prl_generate=' . $generate->prl_generate_id . '&menu=Gaji&Cari=Cari&view=appr&preview=Gaji&pajakonoff=ON&entitas='.$generate->m_lokasi_id]) !!}" target="_blank" title='Approval' data-toggle='tooltip'><span class='fa fa-edit'></span> </a>
                    			@elseif($generate->appr_on_direktur_status==1 and $generate->appr_off_direktur_status!=1)
                    			<a href="{!! route('be.previewgaji', ['direksi', 'prl_generate=' . $generate->prl_generate_id . '&menu=Gaji&Cari=Cari&view=appr&preview=Gaji&pajakonoff=OFF&entitas='.$generate->m_lokasi_id]) !!}" target="_blank" title='Approval' data-toggle='tooltip'><span class='fa fa-edit'></span> </a>
                    			@else
                    				<a href="{!! route('be.previewgaji', ['direksi', 'prl_generate=' . $generate->prl_generate_id . '&menu=Gaji&Cari=Cari&view=appr&preview=Gaji&entitas='.$generate->m_lokasi_id]) !!}" target="_blank" title='Approval' data-toggle='tooltip'><span class='fa fa-edit'></span> </a>
                    			@endif
                    	...
                    	@elseif(@$data['page']=='ajuan')
                    		 <a href="{!! route('be.previewgaji', ['ajuan', 'prl_generate=' . $generate->prl_generate_id . '&menu=Gaji&Cari=Ajuan&view=view&entitas='.$generate->m_lokasi_id]) !!}" target="_blank" title='Preview' data-toggle='tooltip'> <span class='fa fa-eye'></span></a>
                    		 
                    		@if($generate->appr_off_voucher_status==1 and $generate->appr_on_voucher_status==1 )
                    			<a href="{!! route('be.previewgaji', ['ajuan', 'prl_generate=' . $generate->prl_generate_id . '&menu=Gaji&Cari=Ajuan&view=appr&preview=Gaji&entitas='.$generate->m_lokasi_id]) !!}" target="_blank" title='Preview' data-toggle='tooltip'> <span class='fa fa-edit'></span></a>
                    			
                    		@elseif($generate->appr_off_voucher_status==1)
                    			<a href="{!! route('be.previewgaji', ['ajuan', 'prl_generate=' . $generate->prl_generate_id . '&menu=Gaji&Cari=Ajuan&view=appr&preview=Gaji&pajakonoff=OFF&entitas='.$generate->m_lokasi_id]) !!}" target="_blank" title='Preview' data-toggle='tooltip'><span class='fa fa-edit'></span> </a>
                    		@elseif($generate->appr_on_voucher_status==1)
                    			<a href="{!! route('be.previewgaji', ['ajuan', 'prl_generate=' . $generate->prl_generate_id . '&menu=Gaji&Cari=Ajuan&view=appr&preview=Gaji&pajakonoff=ON&entitas='.$generate->m_lokasi_id]) !!}" target="_blank" title='Preview' data-toggle='tooltip'><span class='fa fa-edit'></span> </a>        		
                    		@endif
                    	@endif
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="number" id="nominal_now" value="" class="form-control" placeholder="Nominal Update">
                <textarea  id="keterangan" value="" class="form-control pt-2" placeholder="Keterangan"></textarea>
