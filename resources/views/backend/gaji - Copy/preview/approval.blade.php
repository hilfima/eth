    ...
    @include('flash-message')
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title">Approval Gaji Entitas</h3>
            </div>
           
            <div class="card-body">
            	<?php if(Auth::user()->role==-1 or Auth::user()->role==12){?>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="entitas" name="entitas" required>
                                	...
                                	<?php 
                                	//} 
                                	//if(!$sudah_appr[$entitas->m_lokasi_id]['OFF']){?>
                ...
                <?php }else echo 'Approval Oleh Direktur Utama';?>
            </div>
		...
		<!--<div class="card">
            ...
            <!-- /.card-header -->
            	...
            	Approval <?=$help->tgl_indo($appr->appr_date);?>
            		<div class="mr-auto">
						<a href="<?=route('be.hapus_approval',[$appr->prl_generate_appr_id,$id_prl])?>" class="btn btn-primary" >Hapus</a>
            		</div>
	            </div>
            	<div class="card-body">
            	<?php 
