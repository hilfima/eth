...
@section('content')
    ...
    <!-- Content Header (Page header) -->
        ...
        <div class="card">
            ...
            <form class="form-horizontal" method="POST" action="{!! route('be.simpan_gapok_pekanan') !!}" enctype="multipart/form-data">
...
FROM p_karyawan a
                          ...
                          <h3>Tunjangan</h3> 
                        	<div class="form-group">
                                ...
                                <div class="input-group " id="tgl_posting" data-target-input="nearest">
                                    <input type="text" class="form-control" id="upah_harian" name="upah_harian"  value="Rp "    onkeypress="handleNumber(event, 'Rp {15,3}')"   />
                        ...
                        <h3>Potongan</h3> 
                        	...
                        	<div class="form-group">
                                <label>Infaq</label>
                                <div class="input-group date" id="tgl_posting" data-target-input="nearest">
                                    <input type="text" class="form-control" id="infaq" name="infaq"  value="Rp "    onkeypress="handleNumber(event, 'Rp {15,3}')"   />
                        	...
                        	<div class="form-group">
                                <label>Zakat</label>
                                <div class="input-group date" id="tgl_posting" data-target-input="nearest">
                                    <input type="text" class="form-control" id="zakit" name="zakat"  value="Rp "    onkeypress="handleNumber(event, 'Rp {15,3}')"   />
