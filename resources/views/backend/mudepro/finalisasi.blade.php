...
@section('content')
        ...
        <form action="{!!route('be.update_appr_mudepro',$id)!!}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Tujuan Dapartement</label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control  " name="data[karyawan][<?=$mk->t_mudepro_karyawan_id?>]" id="karyawan" style="width: 100%;" disabled>
                             ...
                             <input type="hidden" class="form-control  " name="data[karyawan][<?=$mk->t_mudepro_karyawan_id?>]" id="karyawan" style="width: 100%;" value="<?=$mk->p_list_karyawan_id?>">
                        </div>
...
<?php }else{?>
                        ...
                        <div id="view-pindah-<?=$mk->t_mudepro_karyawan_id?>" <?php if($mk->status_perpindahan!=1) echo 'style="display:none"'?>>
                        <div class="row">
                    ...
                    <div class="form-group">
                        <label>Finalisasi Dapartement  <?=$nama?></label>
                        <select class="form-control select2 val-input-<?=$mk->t_mudepro_karyawan_id?> " name="data[fiksasi_departement_id][<?=$mk->t_mudepro_karyawan_id?>]" style="width: 100%;"   >
                            ...
                            <?php foreach ($departemen as $dept) { ?>
                                ...
                                <?php
                                if($mudepro[0]->status==2){
                                	echo $mudepro[0]->perpindahan_departement_id==$dept->m_departemen_id?'selected':'';
                                }else{
                                	echo $mk->fiksasi_departemen_id==$dept->m_departemen_id?'selected':'';
                                }
                    ...
                    <div class="form-group">
                        <label>Finalisasi Level <?=$nama?></label>
                        <select class="form-control select2 val-input-<?=$mk->t_mudepro_karyawan_id?>" name="data[fiksasi_pangkat_id][<?=$mk->t_mudepro_karyawan_id?>]" id="karyawan"    style="width: 100%;">
                            <option value="">Pilih Level</option>
                            <?php foreach ($pangkat as $p) { ?>
                                <option value="<?= $p->m_pangkat_id; ?>"
                                <?php
                                if($mudepro[0]->status==2){
                                	echo $mudepro[0]->perpindahan_pangkat_id==$p->m_pangkat_id?'selected':'';
                                }else{
                                	echo $mk->fiksasi_pangkat_id== $p->m_pangkat_id?'selected':'';
                                }
