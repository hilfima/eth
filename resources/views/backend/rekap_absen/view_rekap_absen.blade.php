						...
						<table id="main-table" class="main-table">
							<thead>
								<tr>
									...
									<th scope="col"  style="width: 40px;min-width: 40px;max-width: 40px;font-size: 9px;text-align: center;">Absen </th>
									<th scope="col"  style="width: 40px;min-width: 40px;max-width: 40px;font-size: 8px;text-align: center;">Cuti</th>
									<th scope="col"  style="width: 40px;min-width: 40px;max-width: 40px;font-size: 10px;text-align: center;">IPG</th>
									<th scope="col"  style="width: 40px;min-width: 40px;max-width: 40px;font-size: 10px;text-align: center;">IHK</th>
									<th scope="col"  style="width: 40px;min-width: 40px;max-width: 40px;font-size: 10px;text-align: center;">IPD</th>
									<th scope="col"  style="width: 40px;min-width: 40px;max-width: 40px;font-size: 10px;text-align: center;">IPC</th>
									...
									<th scope="col"  style="width: 40px;min-width: 40px;max-width: 40px;font-size: 10px;text-align: center;">TP</th>
									...
									<th scope="col"  style="width: 40px;min-width: 40px;max-width: 40px;font-size: 10px;text-align: center;">IDT</th>
									<th scope="col"  style="width: 40px;min-width: 40px;max-width: 40px;font-size: 10px;text-align: center;">IPM</th>
									<th scope="col"  style="width: 40px;min-width: 40px;max-width: 40px;font-size: 10px;text-align: center;">PM</th>
								</tr>
							</thead>
							<tbody>
							
								@if(isset($list_karyawan))
									<?php 
								...
								<tr>
									...
									<td  style="width: 40px;min-width: 40px;max-width: 40px;"><?=$masuk?></td>
									<td  style="width: 40px;min-width: 40px;max-width: 40px;"><?=$cuti;?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$ipg;?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$izin;?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$ipd;?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$ipc;?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$sakit;?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$alpha;?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$fingerprint;?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$tabsen?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$tmasuk;?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$tkerja;?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$terlambat?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$idt?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$ipm?></td>
									<td style="width: 40px;min-width: 40px;max-width: 40px;"><?=$pm;?></td>
								</tr>
								@endforeach
								@endif
								@endif
