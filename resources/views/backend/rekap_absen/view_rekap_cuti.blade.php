					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
									...
									if(isset($rekap[$list_karyawan->p_karyawan_id][$date]['ci']['nama_ijin'])){
										...
										if($rekap[$list_karyawan->p_karyawan_id][$date]['ci']['tipe']==3)
											...
											if($rekap[$list_karyawan->p_karyawan_id][$date]['ci']['nama_ijin']
												!= 'IZIN DATANG TERLAMBAT' and $rekap[$list_karyawan->p_karyawan_id][$date]['ci']['tipe']== 3)
								...
								?> 
								<?php $ipd = isset($rekap[$list_karyawan->p_karyawan_id]['total']['cuti'])?$rekap[$list_karyawan->p_karyawan_id]['total']['cuti']:0;?>
