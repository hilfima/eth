							...
							<tr>
								...
								for ($i = 0; $i <= $help->hitunghari($tgl_awal,$tgl_akhir); $i++) {
									...
									if (isset($rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id][$date]['lama'])) {
										...
										echo ' <td '.$color.'>
												'.$rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id][$date]['tgl_awal'].'
												s/d  '.$rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id][$date]['tgl_akhir'].'
												<br>
												'.$rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id][$date]['lama'].' Jam
													<br> '.$rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id][$date]['jam_awal'].'
														s/d  '.$rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id][$date]['jam_akhir'].'
												</td >';
									} else {
								...
								<td>{!!$total_all!!} Jam</td>
								<td><?=isset($rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id]['lembur'])? $rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id]['lembur']['total_pengajuan']:0; ?> Jam</td>
								<td><?=isset($rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id]['lembur'])? $rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id]['lembur']['total_approve']:0; ?> Jam</td>
								<td><?=isset($rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id]['lembur'])? $rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id]['lembur']['total_pending']:0; ?> Jam</td>
								<td><?=isset($rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id]['lembur'])? $rekap['lembur']['ajuan'][$list_karyawan->p_karyawan_id]['lembur']['total_tolak']:0; ?> Jam</td>
