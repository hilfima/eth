...
<h4 class="card-title float-left mb-0 mt-2">Tinjauan Kehadiran Karyawan</h4>
	...
	<div class="card">
		<div class="card-header">
			...
			<form id="cari_absen" class="form-horizontal" method="get" action="{!! route('be.report_absen_karyawan') !!}">
				{{ csrf_field() }}
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="form-group">
							<label>Entitas</label>
							<select class="form-control select2" type="date" name="entitas_absen_search" style="width: 100%;" required >	
		...
		<Style>
			...
			<table id="example1" class="table table-bordered table-striped" style="width: 100%" >
								...
								<th style="text-align: center;vertical-align: middle">TANPA FINGERPRINT</th>
