...
@section('content')
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.3.0/codemirror.min.css">
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{!! route('be.simpan_club') !!}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-12">
                            <!-- text input -->
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nama Club ..." id="judul" name="data[nama]" required>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <!-- text input -->
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Link Group ..." id="judul" name="data[link_group]" required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea id="edit" name="date[keterangan]" class="form-control " required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                                                        <label>Admin</label>
                                                        <select class="form-control select2" name="karyawan_admin[]" multiple  style="width: 100%;" required>
                        ...
                        <div class="form-group">
                                                        <label>Anggota</label>
                                                        <select class="form-control select2" name="karyawan_anggota[]" multiple style="width: 100%;" required>
