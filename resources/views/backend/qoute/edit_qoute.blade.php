...
@section('content')
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.3.0/codemirror.min.css">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{!! route('be.update_qoute',$Qoute[0]->m_qoute_id) !!}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="tgl_posting" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" id="tgl_posting" name="tgl_posting" value="{!! $Qoute[0]->tgl_awal !!}" data-target="#tgl_posting" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea id="edit" class="form-control " name="deskripsi_Qoute" required>{!! $Qoute[0]->qoute !!}</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
