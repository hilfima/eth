    ...
    @include('flash-message')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Rekap Ijin</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{!! route('admin') !!}">Admin</a></li>
                            <li class="breadcrumb-item active">Rekap Ijin</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								...
								<td><?=$ipg=isset($rekap[$list_karyawan->p_karyawan_id]['total']['ipg'])?$rekap[$list_karyawan->p_karyawan_id]['total']['ipg']:0;?></td>
								<td><?=$izin=isset($rekap[$list_karyawan->p_karyawan_id]['total']['ihk'])?$rekap[$list_karyawan->p_karyawan_id]['total']['ihk']:0;?></td>
								<td><?=$ipg+$ipd+$izin;?></td>
