...
@section('content')
    ...
    <!-- Content Header (Page header) -->
        ...
        <div class="card">
			...
			<form class="form-horizontal" method="POST" action="{!! route('be.simpan_excel_koperasi',$page) !!}" enctype="multipart/form-data">
             
            <div class="card-header">
               
                
				<a href="{!! route('be.excel_empty_data_koperasi',$page) !!}"  class="btn btn-sm btn-success" title='Tambah' data-toggle='tooltip'><span class='fa fa-download'></span> Download Template Empty Data</a>
                ...
                <!-- form start -->
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-6">
                        ...
                        Note:<br>
                        Tangga WAJIB Format yyyy-mm-dd..  <br>
                        Jika tanggal masih dd/mm/yyyy maka klik Number Format -> More Number Format -> Costum -> Ketikan pada type: nya dengan yyyy-mm-dd
