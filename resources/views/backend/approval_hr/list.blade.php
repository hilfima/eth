    ...
    @include('flash-message')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Approval HR</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title mb-0">Approval HR</h3>
            </div> 
            <!-- /.card-header -->
            <div class="card-body">
                    ...
                    @if(!empty($data))
                        @foreach($data as $data)
                            ...
                            <tr>
                                ...
                                <td><div style="text-align: center">Atasan 1<br>{!! $data->nama_appr !!}</div>
                                <?php if($data->m_jenis_ijin_id ==22){echo '<br><hr style="margin: 5px 0;"><div style="text-align: center">Atasan 2<br>	'.$data->nama_appr2.'</div>'; }?>
                                </td>
                                <td style="text-align: center">
                                	<div style="text-align: center">Approval 1:</div>
                                    @if($data->appr_1==null)
                                    	<span><br></span>
                                    ...
                                    @endif
                                    <?php if($data->m_jenis_ijin_id ==22){?>
                                   <hr style="margin: 5px 0;">
                                   <div style="text-align: center">Approval2:</div>
                                    ...
                                    @if($data->status_appr_hr==1)
                                        <span class="fa fa-check-circle"> Disetujui</span>
                                        @elseif($data->status_appr_hr==2)
                                            <span class="fa fa-window-close"> Ditolak</span>
                                    @else
                                        <span class="fa fa-edit"> Pending</span>
                                    @endif
                                ...
                                <td style="text-align: center">
                                    <a href="{!! route('be.lihat_hr_appr',[$data->t_form_exit_id]) !!}" title='Lihat' data-toggle='tooltip'><span class='fa fa-search'></span></a>
                                </td>
                            </tr>
                        @endforeach
                    @endif
