...
@section('content')
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.3.0/codemirror.min.css">
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{!! route('be.simpan_berita') !!}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-6">
                            <!-- text input -->
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Judul Berita ..." id="judul" name="judul" required>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="tgl_posting" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" id="tgl_posting" name="tgl_posting" data-target="#tgl_posting" />
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="tgl_posting_akhir" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" id="tgl_posting_akhir" name="tgl_posting_akhir" data-target="#tgl_posting_akhir" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea id="edit" name="deskripsi_berita" class="form-control " required></textarea>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
