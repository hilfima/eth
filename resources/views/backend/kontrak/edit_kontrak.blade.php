...
@section('content')
    ...
    <!-- Content Header (Page header) -->
        ...
        <div class="card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{!! route('be.update_kontrak',$id) !!}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>NIK</label>
                                                        <input type="text" class="form-control" disabled="disabled" value="{!! $kontrak[0]->nik !!}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Entitas</label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group " id="tgl_awal" data-target-input="nearest">
                                                            <input type="date" class="form-control" id="tgl_awal" name="tgl_awal" data-target="#tgl_awal" required value="{!! date('Y-m-d',strtotime($kontrak[0]->tgl_awal)) !!}"/>
                                                   ...
                                                   <div class="form-group">
                                                        <label>Kantor</label>
                                                        <select class="form-control select2" name="kantor" style="width: 100%;" >
                                                            <?php
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>Nama</label>
                                                        <input type="text" class="form-control" id="nama" name="nama" disabled="disabled" value="{!! $kontrak[0]->nama_lengkap !!}">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group " id="tgl_akhir" data-target-input="nearest">
                                                            <input type="date" class="form-control" id="tgl_akhir" name="tgl_akhir" data-target="#tgl_akhir" value="{!! date('Y-m-d',strtotime($kontrak[0]->tgl_akhir)) !!}"/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Keterangan..." id="keterangan" name="keterangan" value="{!! $kontrak[0]->keterangan !!}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
