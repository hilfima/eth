                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Lihat Penilaian Kinerja</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label>Nama</label>
                                <select class="form-control select2" name="nama" style="width: 100%;" disabled>
                            ...
                            <div class="form-group">
                                <label>Penilai</label>
                                <select class="form-control select2" name="manager" style="width: 100%;" disabled>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" id="tanggal" name="tanggal" data-target="#reservationdate" required value="{!! date('d-m-Y',strtotime($pa[0]->tanggal)) !!}" disabled/>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="direktur" style="width: 100%;" disabled>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4" style="text-align: center">
                                            <div class="icheck-primary d-inline">
                                                <input disabled type="radio" id="[{{$padetil->m_pa_id.'_radioPrimary4'}}]" name="pilihan[{{$padetil->m_pa_id}}]" value="{!! $pilihan_a !!}"
                                            ...
                                            <div class="icheck-primary d-inline">
                                                <input disabled type="radio" id="[{{$padetil->m_pa_id.'_radioPrimary3'}}]" name="pilihan[{{$padetil->m_pa_id}}]" value="{!! $pilihan_b !!}"
                                            ...
                                            <div class="icheck-primary d-inline">
                                                <input disabled type="radio" id="[{{$padetil->m_pa_id.'_radioPrimary2'}}]" name="pilihan[{{$padetil->m_pa_id}}]" value="{!! $pilihan_c !!}"
                                            ...
                                            <div class="icheck-primary d-inline">
                                                <input disabled type="radio" id="[{{$padetil->m_pa_id.'_radioPrimary1'}}]" name="pilihan[{{$padetil->m_pa_id}}]" value="{!! $pilihan_d !!}"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="icheck-primary d-inline">
                                        <input disabled type="radio" id="rekomendasi1" name="rekomendasi" value="Putus Hubungan Kerja"
                                    ...
                                    <div class="icheck-primary d-inline">
                                        <input disabled type="radio" id="rekomendasi2" name="rekomendasi" value="Perpanjangan Kontrak"
                                    ...
                                    <div class="icheck-primary d-inline">
                                        <input disabled type="radio" id="rekomendasi3" name="rekomendasi" value="Lainnya"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" id="deskripsi" name="deskripsi" class="form-control" required value="" disabled>{!! $pa[0]->keterangan !!}</textarea> 
                                    </div>

                                    <div class="form-group">
                                        <label for="deskripsi_dir">Keterangan Direktur :</label>
                                        <textarea type="text" id="deskripsi_dir" name="deskripsi_dir" class="form-control" required value="" disabled>{!! $pa[0]->keterangan_direktur !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            <hr>
