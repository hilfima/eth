                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            ...
                            <a href="{!! route('fe.acc_pergantian_hari_libur',$izin->t_pergantian_hari_libur_id) !!}" class="btn btn-success" title='Hapus' data-toggle='tooltip'>Approve</a>
                            <a href="{!! route('fe.dec_pergantian_hari_libur',$izin->t_pergantian_hari_libur_id) !!}" class="btn btn-danger" title='Hapus' data-toggle='tooltip'>Tolak</a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
