...
<div class="content">
    ...
    <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form id="cari_absen" class="form-horizontal" method="get" action="{!!route('be.ajuan_pergantian_hari_libur')!!}">
                {{csrf_field()}}
                <div class="row">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <a href="{!!route('be.ajuan_pergantian_hari_libur')!!}" class="btn btn-primary"><span class="fa fa-sync"></span> Reset</a>
