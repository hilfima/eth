...
@section('content')
    ...
    @include('flash-message')
        ...
        <div class="card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{!! route('be.simpan_departemen') !!}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-6">
                            <!-- text input -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="keterangan" name="keterangan" placeholder="Keterangan ..." class="form-control" rows="2"></textarea>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
