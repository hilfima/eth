                ...
                <form class="form-horizontal" method="POST" action="{!! route('be.update_alasan_jenis_ijin',$id) !!}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label>Alasan</label>
                                <input type="text" class="form-control" placeholder="Alasan..." id="judul" name="data[alasan]" value="<?=$alasan_jenis_ijin[0]->alasan;?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" placeholder="Nama Batas ..." id="batas_tipe" name="data[jenis]"   required>
                                    ...
                                    <option value="<?=$jenis->m_jenis_ijin_id;?>" <?=$alasan_jenis_ijin[0]->jenis==$jenis->m_jenis_ijin_id?'selected':'';?>><?= $jenis->nama;?></option>
                                    <?php }?>
                                </select>
                            </div>
