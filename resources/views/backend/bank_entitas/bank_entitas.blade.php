...
<div class="content-wrapper">
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="{!! route('be.bank') !!}"><?=ucwords('Bank Entitas'); ?></a></li>
	...
	<div class="card">
		<div class="card-header">
			...
			<a href="{!! route('be.tambah_bank') !!}" title='Tambah' data-toggle='tooltip'><span class='fa fa-plus'></span>  <?=ucwords('Bank Entitas'); ?> </a>
		</div>
		<!-- /.card-header -->
		<div class="card-body">
