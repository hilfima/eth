        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{!! route('fe.update_klarifikasi',$id_chat) !!}" enctype="multipart/form-data">
						...
						<option value="' . $appr->p_karyawan_id . '" ' . $selected . '>' . $appr->nama_lengkap . '</option>';
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control " id="tgl_absen" name="appr_hr_status" required="" readonly>
                                    <option value="">Pilih Approval</option>
                                    <option value="1" <?= $chat_list[0]->appr_hr_status == 1 ? 'selected' : ''; ?>>Setujui</option>
                                    <option value="2" <?= $chat_list[0]->appr_hr_status == 2 ? 'selected' : ''; ?>>Tolak</option>
                                </select>
						...
						<a href="' . asset('dist/img/file/' . $chat_list[0]->file_hr) . '" target="_blank" title="Download"><span class="fa fa-download"></span></a>'; ?>
                                ...
                                <input class="form-control " id="tgl_absen" name="file_hr" type="file" readonly>
                            </div>
                            <div class="form-group">
                                <label>Approval </label>
                                <select class="form-control " id="tgl_absen" name="appr_status" required="">
                                    <option value="">Pilih Approval</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control " id="tgl_absen" name="keterangan_atasan" placeholder="Keterangan Atasan"><?= $chat_list[0]->keterangan_atasan; ?></textarea>
                            </div>
