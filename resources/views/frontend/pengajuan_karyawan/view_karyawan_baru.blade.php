...
<ul class="nav nav-tabs float-right border-0 tab-list-emp">
        ...
        <div class="card">
            <div class="card-header">
               <h3 class="card-title mb-0 pb-0">Lihat</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <!-- form start -->
                    ...
                    <div class="row">
                        ...
                        <br>
                        <div >
                        <?php if($view =='approve_atasan' or $view =='approve_keuangan' or $view =='approve_direksi' or $view =='' ){?>
                        <form class="form-horizontal" method="POST" action="{!! route('fe.simpan_approval_karyawan_baru',$tkaryawan[0]->t_karyawan_id) !!}" enctype="multipart/form-data" onsubmit="return confirm('Apakah anda yakin?');">
                            {{ csrf_field() }}
                        ...
                        <?php }?>
                        <?php if($view =='approve_keuangan' or $view =='approve_direksi' or $view =='' ){?>
                        <div >
                        ...
                        <br>     
                                    ...
                                    <div class="form-group">
                                     ...
                                     <br>
                                     <?php }?>
                        <?php if($view =='approve_direksi' or $view =='' ){?>
                        <div >
                        ...
                        <?php if($view =='approve_atasan' or $view =='approve_keuangan' or $view =='approve_direksi' ){?>
