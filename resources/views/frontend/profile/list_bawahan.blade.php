...
<div class="col-xl-9 col-lg-8 col-md-12">  @include('flash-message')
...
<div class="card shadow-sm ctm-border-radius">
	<div class="card-body align-center">
		<h4 class="card-title float-left mb-0 mt-2">Daftar Tim</h4>

	</div>
</div><div class="row">
	<?php foreach($karyawan as $karyawan){?>
	<div class="col-md-3 text-left" onclick="location.href='{!!route('fe.lihat_karyawan',$karyawan->p_karyawan_id)!!}'">
