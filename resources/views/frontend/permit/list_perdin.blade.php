...
<div class="content">
    ...
    <div class="card shadow-sm ctm-border-radius">
        <div class="card-body align-center">
            <h4 class="card-title float-left mb-0 mt-2">Perjalanan Dinas</h4>
            <ul class="nav nav-tabs float-right border-0 tab-list-emp">

				<li class="nav-item pl-3">
					<a href="{!! route('fe.tambah_perdin') !!}" title='Tambah'  class="btn btn-theme button-1 text-white ctm-border-radius p-2 add-person ctm-btn-padding">Tambah Izin Perjalanan Dinas</a>
				</li>
			</ul>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <a href="{!! route('fe.lihat_perdin',$izin->t_form_exit_id) !!}" class="btn btn-theme button-1 text-white ctm-border-radius p-2 add-person ctm-btn-padding" title='Lihat' data-toggle='tooltip'><span class='fa fa-search'></span></a>
                            @if($izin->status_appr_1==3)
                            <a href="{!! route('fe.hapus_perdin',$izin->t_form_exit_id) !!}" class="btn btn-theme button-1 text-white ctm-border-radius p-2 add-person ctm-btn-padding" title='Hapus' data-toggle='tooltip'><span class='fa fa-trash'></span></a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
