...
<h4 class="card-title float-left mb-0 mt-2">Edit Key Perfomance Indicator</h4>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{!! route('fe.update_kpi',$kpi[0]->t_kpi_id) !!}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <!--<div class="row">-->
                        <!--<div class="col-sm-2">-->
                            <!-- text input -->
                        ...
                        <!--<div class="col-sm-3">-->
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" placeholder="Tahun..." value="<?=$kpi[0]->tanggal_awal;?>" id="tahun" name="tanggal_awal" value="{{date('Y-m-d')}}"></input>
                            </div>
                            <div class="form-group">
                                <label>Tanggal Akhir*</label>
                                <input class="form-control" type="date" placeholder="Tahun..." value="<?=$kpi[0]->tanggal_akhir;?>" id="tahun" name="tanggal_akhir" value="{{date('Y-m-d')}}"></input>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" type="date" placeholder="Tahun..." id="tahun" name="tipe_pencapaian">
                                    ...
                                    <option <?=$kpi[0]->tipe_pencapaian=='Individu'?'selected':'';?>>Individu</option>
                                    <option <?=$kpi[0]->tipe_pencapaian=='Tim'?'selected':'';?>>Tim</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="atasan" style="width: 100%;" >
                                    ...
                                    foreach($appr1 AS $appr1){
                                        echo '<option value="'.$appr1->p_karyawan_id.'" '.($appr1->p_karyawan_id ==$kpi[0]->atasan_1?'selected':'').'>'.$appr1->nama_lengkap.'</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="atasan2" style="width: 100%;" required>
                                    ...
                                    foreach($appr2 AS $appr){
                                        echo '<option value="'.$appr->p_karyawan_id.'" '.($appr->p_karyawan_id ==$kpi[0]->atasan_2?'selected':'').'>'.$appr->nama_lengkap.'</option>';
                                    }
                                    ?>
                                </select>
                            </div>
