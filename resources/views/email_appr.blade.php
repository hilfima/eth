                                        ...
                                        <tr>
                                                ...
                                                <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="button" height="45">
                                                            <a href="http://203.210.84.185:84/approve_cuti/{!! $data[0]->kode !!}" target="_blank">Setuju</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td style="padding: 20px 0 0 0;">
                                                <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="button" height="45">
                                                            <a href="http://203.210.84.185:84/reject_cuti/{!! $data[0]->kode !!}" target="_blank">Tolak</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
