    ...
    @include('flash-message')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Pengajuan Izin Perjalanan Dinas</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{!! route('home') !!}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{!! route('fe.permit') !!}">Permit</a></li>
                            <li class="breadcrumb-item active">Izin Perjalanan Dinas</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{!! route('fe.tambah_perdin') !!}" title='Tambah' data-toggle='tooltip'><span class='fa fa-plus'></span> Tambah Izin Perdin</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
