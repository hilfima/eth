                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="deskripsi" name="deskripsi" class="form-control" required value="{!! $pa[0]->keterangan !!}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="deskripsi_dir">Keterangan Direktur :</label>
                                        <input type="text" id="deskripsi_dir" name="deskripsi_dir" class="form-control" required value="{!! $pa[0]->keterangan_direktur !!}" disabled>
                                    </div>
                                </div>
                            </div>
                            <hr>
