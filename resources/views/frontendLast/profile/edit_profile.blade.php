                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group date" id="tgl_lahir" data-target-input="nearest">
                                                                        <input type="text" class="form-control datetimepicker-input" id="tgl_lahir" name="tgl_lahir" data-target="#tgl_lahir" value="{!! $karyawan[0]->tgl_lahir !!}">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    @if($karyawan[0]->foto!=null)
                                                                        <img src="{!! asset('dist/img/profile/'.$karyawan[0]->foto) !!}" alt="User Avatar" class="img-size-64 mr-3 img-thumbnail">
                                                                    @else
                                                                        <img src="{!! asset('dist/img/profile/user.png') !!}" class="img-size-64 mr-3 img-circle elevation-2" alt="User Image">
                                                                    @endif
