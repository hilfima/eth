                                            ...
                                            <div class="user-notification-block align-right d-inline-block">
                                                <ul class="list-inline m-0">
                                                    ...
                                                    <li class="list-inline-item item-animated" data-toggle="tooltip" data-placement="top" title="" data-original-title="Berita">
                                                        <a href="#" data-toggle="modal" data-target="#berita" class="font-23 menu-style text-white align-middle ">
                                                            <span class="la la-comment position-relative" style="color:black"><span class="badge badge-<?= count($berita) + count($pjs) ? 'danger' : 'light'; ?>"><?= count($berita) + count($pjs) ?></span></span>
                                                        </a>
                                                    </li>
                                                    <li class="list-inline-item item-animated" data-toggle="tooltip" data-placement="top" title="" data-original-title="Berita">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <a href="javascript:void(0)" class="dash-card text-dark">
                            ...
                            <!--<fai  id="lessberita-<?= $ber->hr_care_id ?>" style="display: block">{!! substr($ber->deskripsi,0,200) !!}</fai>-->
                            <div id="contentberita-<?= $ber->hr_care_id ?>" data-visible="0">{!! str_ireplace(array('Powered By','Froala Editor','href="https://www.froala.com/wysiwyg-editor'),array('','','href="#"'),$ber->deskripsi)
                                !!}</div>

                            <!--<button onclick="readmore(<?= $ber->hr_care_id ?>,this)">Selengkapnya</button>--><?php
                                                                                                                    ?>
                            <hr>
                        </a>
                        ...
                        <a href="javascript:void(0)" class="dash-card text-dark">
                            <div class="dash-card-container">
                                ...
                                <div class="dash-card-content">
                                    <h6 class="mb-0">
                                        <p>Anda Menjadi Penanggung Jawab Sementara dari Perkerjaan <?= $pjs->nama; ?></p>
                                    </h6>
                                </div>
                            </div>
                            <div id="contentberita" data-visible="0"><?= $pjs->nama; ?> tidak masuk hari ini karena <?= $pjs->nama_ijin; ?>
                            </div>
